 ...
 * @author ADRIANA
 */
public class RegistrarClienteM extends javax.swing.JFrame {

    /**
     * Creates new form RegistrarClienteM
     */
    public RegistrarClienteM() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarClienteM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarClienteM().setVisible(true);
            }
        });
    }
